...
export const SC=[
  ...
  {cod:"1.2.M.D2.2",elem:"muro",sistemas:["Hormigon celular autoclavado"],desc:"Bloque HCA 200mm + EPS SATE exterior 60mm",capas:"Estuco 10 | HCA 500 200 | EPS 20kg 60 | Malla | Revoque mineral",u:0.31,rf:"F180",ac_rw:43,zonas:"ABCDEFGHI",usos:["Vivienda","Educacion","Salud","Oficina"],obs:"HCA 500 lambda=0.13 + EPS lambda=0.040 (NCh853). U=0.31 calculado ISO 6946. RF F180. Cumple todas las zonas A-I."},
  ...
  {cod:"1.2.M.A27.1",elem:"muro",sistemas:["Hormigon armado","Albanileria confinada","Albanileria armada","Mixta HA + albanileria"],desc:"Macizo + Weber.therm lana de roca 80mm (SATE)",capas:"Muro macizo | Lana de roca 80 | Malla | Revoque Weber.therm",u:0.42,rf:"F60",ac_rw:54,zonas:"ABCDEFGH",usos:["Vivienda","Educacion","Salud","Oficina","Comercio"],obs:"Weber.therm (Saint-Gobain). Lana de roca lambda=0.040, incombustible A1. U=0.42@80mm calculado ISO 6946 sobre macizo tipico. RF depende del muro base (>=F60). Alta acustica."},
