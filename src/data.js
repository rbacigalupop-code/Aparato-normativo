...
export const SC=[
  ...
  {cod:"1.2.M.D1.2",elem:"muro",sistemas:["Hormigon celular autoclavado"],desc:"Bloque HCA 200mm (500 kg/m3) estucado ambas caras",capas:"Estuco 10 | HCA 500 200 | Estuco 10",u:0.58,rf:"F180",ac_rw:42,zonas:"ABCDE",usos:["Vivienda","Educacion","Oficina"],obs:"HCA 500 kg/m3 lambda=0.13. U=0.58. RF F180. Zonas A-E. Portante hasta 2 pisos."},
  {cod:"1.2.M.D2.1",elem:"muro",sistemas:["Hormigon celular autoclavado"],desc:"Bloque HCA 150mm + EPS SATE exterior 40mm",capas:"Estuco 10 | HCA 500 150 | EPS 20kg 40 | Malla | Revoque mineral",u:0.43,rf:"F120",ac_rw:41,zonas:"ABCDEFG",usos:["Vivienda","Educacion","Oficina"],obs:"HCA 500 lambda=0.13 + EPS lambda=0.040. U=0.43. RF F120. Zonas A-G."},
  {cod:"1.2.M.D2.2",elem:"muro",sistemas:["Hormigon celular autoclavado"],desc:"Bloque HCA 200mm + EPS SATE exterior 60mm",capas:"Estuco 10 | HCA 500 200 | EPS 20kg 60 | Malla | Revoque mineral",u:0.31,rf:"F180",ac_rw:43,zonas:"ABCDEFGHI",usos:["Vivienda","Educacion","Salud","Oficina"],obs:"HCA 500 lambda=0.13 + EPS lambda=0.040. U=0.31. RF F180. Cumple todas las zonas A-I."},
  {cod:"1.2.M.D2.3",elem:"muro",sistemas:["Hormigon celular autoclavado"],desc:"Bloque HCA 200mm + lana mineral SATE exterior 80mm",capas:"Estuco 10 | HCA 500 200 | Lana mineral 80 | Malla | Revoque mineral",u:0.27,rf:"F180",ac_rw:44,zonas:"ABCDEFGHI",usos:["Vivienda","Educacion","Salud","Oficina"],obs:"HCA 500 lambda=0.13 + LM lambda=0.040. U=0.27. RF F180. Alta eficiencia todas las zonas."},
  ...
  {cod:"1.2.M.A27.1",elem:"muro",sistemas:["Hormigon armado","Albanileria confinada","Albanileria armada","Mixta HA + albanileria"],desc:"Macizo + Weber.therm lana de roca 80mm (SATE)",capas:"Muro macizo | Lana de roca 80 | Malla | Revoque Weber.therm",u:0.42,rf:"F60",ac_rw:54,zonas:"ABCDEFGH",usos:["Vivienda","Educacion","Salud","Oficina","Comercio"],obs:"Weber.therm (Saint-Gobain). Lana de roca lambda=0.040, incombustible A1. U=0.42@80mm sobre macizo tipico. RF depende del muro base (>=F60). Alta acustica."},
  ...
  {cod:"1.2.M.A28.1",elem:"muro",sistemas:["Hormigon armado","Albanileria confinada","Albanileria armada","Mixta HA + albanileria"],desc:"Macizo + Dryvit Outsulation EPS 100mm (SATE)",capas:"Muro macizo | EPS 20kg 100 | Malla | Acabado Dryvit Outsulation",u:0.33,rf:"F60",ac_rw:48,zonas:"ABCDEFGH",usos:["Vivienda","Educacion","Oficina","Comercio"],obs:"Dryvit Outsulation. EPS blanco 20kg lambda=0.038. U=0.33@100mm sobre macizo tipico. RF depende del muro base (>=F60)."},
